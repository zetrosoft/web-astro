...
<div class="my-8 p-6 sm:p-8 rounded-3xl bg-slate-900 text-white border border-slate-800 shadow-2xl overflow-hidden relative not-prose">
  ...
  <div class="space-y-4 relative">
    <div class="flex flex-col sm:flex-row items-center gap-4 bg-slate-800/90 p-4 rounded-2xl border border-slate-700 hover:border-rose-500/50 transition-all">
      ...
      <span class="text-[11px] font-semibold bg-slate-950 text-amber-400 px-3 py-1 rounded-lg border border-slate-700 shrink-0">
        World Asset
      </span>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
      <div class="md:col-span-7 flex flex-col sm:flex-row items-center gap-4 bg-slate-800/90 p-4 rounded-2xl border border-slate-700 hover:border-rose-500/50 transition-all">
        <div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-rose-500 to-amber-500 flex items-center justify-center text-white font-black text-sm shrink-0 shadow">
          02
        </div>
        <div class="flex-1 text-center sm:text-left">
      ...
      <div class="md:col-span-5 flex items-center justify-center sm:justify-start gap-3 bg-rose-950/50 p-4 rounded-2xl border border-rose-800/60 text-rose-200">
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
      ...
      <div class="md:col-span-5 flex items-center justify-center sm:justify-start gap-3 bg-emerald-950/50 p-4 rounded-2xl border border-emerald-800/60 text-emerald-200">
        <span class="text-base font-bold">➔</span>
        <div>
    ...
    <div class="flex flex-col sm:flex-row items-center gap-4 bg-slate-800/90 p-4 rounded-2xl border border-slate-700 hover:border-rose-500/50 transition-all">
      ...
      <span class="text-[11px] font-semibold bg-slate-950 text-rose-400 px-3 py-1 rounded-lg border border-slate-700 shrink-0">
        On-Chain Token
      </span>
    </div>
    ...
    <div class="flex flex-col sm:flex-row items-center gap-4 bg-gradient-to-r from-rose-950/60 via-slate-800 to-amber-950/60 p-4 rounded-2xl border border-rose-500/50 shadow-lg">
      <div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-rose-500 to-amber-500 flex items-center justify-center text-white font-black text-sm shrink-0 shadow">
        05
      </div>
      <div class="flex-1 text-center sm:text-left">
